...
interface FilterDisplayProps {
  ...
  rerenderFilters: React.MutableRefObject<any>
  onClear: () => void
}

const FilterDisplay = forwardRef<HTMLDivElement, FilterDisplayProps>(
  ({ FilterRef, onClear, rerenderFilters }, ref) => {
    ...
    useImperativeHandle(rerenderFilters, () => ({
    ...
    return (
      <div
        className="mt-4 inline-flex h-[29px] items-center justify-center gap-4"
        ref={ref}
      >
