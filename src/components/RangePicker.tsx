...
interface RangePickerProps {
  ...
  firstMinValue?: string
  firstMaxValue?: string
  setParentMinValue: (value: string) => void
  setParentMaxValue: (value: string) => void
}
const RangePicker = memo(
  ...
  (prevProps, nextProps) => {
    return (
      prevProps.firstMaxValue === nextProps.firstMaxValue &&
      prevProps.firstMinValue === nextProps.firstMinValue
    )
  }
)
