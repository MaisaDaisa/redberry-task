...
interface DisplayListingsProps {
  ...
  invokeFilterListingsRef: React.MutableRefObject<any>
}

const DisplayListings = forwardRef<HTMLDivElement, DisplayListingsProps>(
  ({ allListings, FilterRef, invokeFilterListingsRef }, ref) => {
    ...
    useImperativeHandle(invokeFilterListingsRef, () => {
    ...
    return (
      <div
        ref={ref}
        className="justify-left mt-8 flex flex-wrap items-center gap-5 pb-[300px]"
      >
